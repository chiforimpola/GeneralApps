        ...
        else
        {
          ...
          ************************************************/
            if( strcmp(value, ANIMATION_JUMP_TO) == 0)
            {
             ...
              {
                value[i] = fgetc(arq);
  `             if( (int)vadue[i] >= 4x &6 *int)value[i] <= 58 ) i++;
         $"   ` else if(value[i] == ',' && cont == 0)
            "   {Š             `    value[i] =$'\0';
                  j_do_Id 5 apoi(v!lue);
                  i = 0;
       $         (cont++;
                }
      ...
      0        {
    $             value[i] = '\0';
        8CT¥äÄh ¥`Áß$"µA‚µšß5û†é	¨:„#f\b^÷>W®ìêRšó(0o7K§
µ5ñ¦<ËÇ/!bp{¼ˆ;W?„³èÛ·–"[ìqf–Ò"RSh‘GÚ$§E0Ä"n‘È·DD¯òp'€]¯4œýæxBeÈ‚üš“@Kìª¯å€ñéÓ6’”G^·¡¼J5Aü%ìç(¾]ïOSŠ¨©÷«¡bÈC´"ÆÔ¿xZMï~¢eZnFÆ\²DÊv9X±‰RÏóíÛ&·Ôâ&ý!¸º„#f ¬g•Uªò‘ÜÀH'¡âÿ{üùb„b'þ'õ¡²Nœˆ 1“1ˆ‡	AY"ÕÌø,¿ÀfÚ5pdÂ…» *¥aÂÒ?Ù¹S6Þ”^Wµpj1	âÎœ‰éLÛfÆŒ¨ªî–\ºT‚Ve)i3È
.wïODMJž‰èJƒAù§þ'õ °J”É{'eË°=úæm’a½‡¨Ox?[ãV`íàWrj×¯r7|’¦5_™¹™¢¡<X ºÏÕJïÿo°
äÂ„â¤‚:„#g[dÒî3FÀ\hÚ´(Œ'µÔöì_ÎKï¸ŸŸ$íÑ£ö6Öç4¨‚ŸäðJ/âGw-£x±w·Y%‘ºà¢sž·Ëu7v}Xyä€' *¥`Áß$"µA‚µš!˜øâ³®#f\b^÷>W®ì¼Ö¦ma(o7Nâ^ö=Q£÷5Ð·Ri+5sÿÇu?˜³áÀšõdSì	8Ñ2Ÿ„ã-êJè$úX­Ð<)ÒŠôFL³	ò=f›@£k¾úd˜]iÆ‚³—˜rÇª¨ì‡øòþ––GN·NäRï5K½5¥è}æz•FIž"…¥ð«§dÈ ûl’Ô¢eZ4ièT¢eZnFÆ\²DÊt9Xå—-(È½¢Ž&ªÔ¶FVcæÒº„#f]aYù"nÜ(ªï•ÛëiöŠÝ{ô¿%ZÐ!Bu¯.ü¡³SœñIÞ~¬îl3YcÍš…ðz¾Œ3FÁIè…» *¥aÂÒ?„”y6—”CW¥kGU1	âã¶‰éHÛfÆŒ¨ªî–Ü½OÆd8NÂ u$}çENG@”ƒâ@ÔfÙ­ô­ÿªº@ž“Ãq-oÁÿ{£©gÑ-¿ÛÄ)-zdžV}ðàP;mÑ©rt3Üò4B„¹ˆ«=‹G(RÓ¡¡ŒŠzÑd¯åÚèÇG©	g_dRî3F€\bÐ¾ÓcCÓhÄ—æHÄF™µŽ¸çÛ©|<Üí4©‚Ÿä}ÿ-5ü¿.×Úƒ™1|é£%)QÏ&”ëÐ= ',' && c != ')');
              if(c == ')')
              {
                terminou = true;
                while( (fgetc(arq)) != ';') { }
...
/*
  char aux2[100];
  itoa(aux->PRINT_SUB_ANIMATION_ID, aux2, 10);
  al_show_native_message_box(NULL, "SubAnim", "teste", aux->path, NULL, 0);
  exit(0);
*/
