...
class Color:
    ...
    def setForeground (self, colorName = ""):
        if colorName != "":
            ...
            if self.bck_foreground == '': self.bck_foreground = colorName
        else:
           sys.stdout.write (self.foreground['default'])
           if self.bck_foreground == '': self.bck_foreground = 'default'

    def setBackground (self, colorName = ""):
        if colorName != "":
            sys.stdout.write (self.background[colorName])
            if self.bck_background == '': self.bck_background = colorName
        else:
           sys.stdout.write (self.background['default'])
           if self.bck_background == '': self.bck_background = 'default'
    ...
    def cout (self, color, msg):
        ...
        #self.setForeground (self.bck_foreground)
        self.setForeground()
